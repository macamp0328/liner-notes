...
Local install for the generator: `brew install inframap graphviz` on macOS. CI uses `go install github.com/cycloidio/inframap@v0.8.1` plus `apt-get install graphviz` — matching the command in [`diagrams.yml`](.github/workflows/diagrams.yml).
