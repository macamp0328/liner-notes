...
| `MB_RELEASED_IN_REGION` | Master → Region              | `mbReleaseId` (merge key), `date`, `formats`, `source` (`"musicbrainz"`) — #441 Region counterpart of `MB_RELEASED_IN` (MB `XE`/`XW` Europe/Worldwide events).                                                                                                                                                                                                                                                                                                                      |
