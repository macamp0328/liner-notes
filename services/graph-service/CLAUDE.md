...
**16** pipelines — `lyrics`, `nationality`, `master-data`, `mb-release-events`, `track-musicbrainz`,
...
- `POST /api/v1/admin/<stage>/reset` — force a full re-fetch. **Exists for 11 stages only** — the
