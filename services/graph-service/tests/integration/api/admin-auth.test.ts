...
const ADMIN_ROUTES: { method: 'GET' | 'POST'; url: string }[] = [
  ...
  { method: 'POST', url: '/api/v1/admin/track-works/enrich' },
  { method: 'POST', url: '/api/v1/admin/track-works/reset' },
  { method: 'GET', url: '/api/v1/admin/track-works/status' },
  { method: 'POST', url: '/api/v1/admin/track-recording-artists/enrich' },
  { method: 'POST', url: '/api/v1/admin/track-recording-artists/reset' },
  { method: 'GET', url: '/api/v1/admin/track-recording-artists/status' },
  { method: 'POST', url: '/api/v1/admin/track-recording-places/enrich' },
  { method: 'POST', url: '/api/v1/admin/track-recording-places/reset' },
  { method: 'GET', url: '/api/v1/admin/track-recording-places/status' },
  { method: 'POST', url: '/api/v1/admin/track-recording-lineage/enrich' },
  { method: 'POST', url: '/api/v1/admin/track-recording-lineage/reset' },
  { method: 'GET', url: '/api/v1/admin/track-recording-lineage/status' },
  ...
  { method: 'POST', url: '/api/v1/admin/artist-wikidata/enrich' },
  { method: 'POST', url: '/api/v1/admin/artist-wikidata/reset' },
  { method: 'GET', url: '/api/v1/admin/artist-wikidata/status' },
  ...
  { method: 'POST', url: '/api/v1/admin/mb-artist-id/enrich' },
  { method: 'POST', url: '/api/v1/admin/mb-artist-id/reset' },
  ...
  { method: 'POST', url: '/api/v1/admin/band-membership/enrich' },
  { method: 'GET', url: '/api/v1/admin/band-membership/status' },
